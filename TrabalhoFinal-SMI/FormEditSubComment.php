...
<html>
    ...
    <body>
        ...
        <section class="content">
            ...
            mysql_select_db($GLOBALS['configDataBase']->db,
                    $GLOBALS['ligacao']);

            $idComment = filter_input(INPUT_GET, 'idComment',
                    FILTER_VALIDATE_INT);+
            $queryComment = "SELECT * FROM `trabfinal-comment`".
            ...
            <form 
                ...
                action="processFormEditSubComment.php"
                method="POST"
                name="FormUpload">
                <textarea 
                    name="comment" 
                    ...
                    cols="45" 
                    rows="4"><?php echo $rowComment['contents'] ?>
                </textarea>
                <br>
                <input 
                    type="hidden" 
